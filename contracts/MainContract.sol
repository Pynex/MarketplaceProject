...
contract MainContract is IMainContract, Ownable, ReentrancyGuard , Errors{
     ...
     *  @inheritdoc IMainContract
     */
    function getQuantity(address _colelctionAddress) public view returns (uint256) {
        ICollectionManager cm = ICollectionManager(collectionManager);
        ICollectionManager.CollectionInfo memory collection = cm.getCollectionByAddress(_colelctionAddress);
     ...
     *  @inheritdoc IMainContract
     */
    function getPrice(address _colelctionAddress) public view returns (uint256) {
        ICollectionManager cm = ICollectionManager(collectionManager);
        ICollectionManager.CollectionInfo memory collection = cm.getCollectionByAddress(_colelctionAddress);
     ...
     *  @inheritdoc IMainContract
     */
    function getCollectionOwnerByAddress(address _colelctionAddress) public view returns (address) {
        ICollectionManager cm = ICollectionManager(collectionManager);
        ICollectionManager.CollectionInfo memory collection = cm.getCollectionByAddress(_colelctionAddress);
